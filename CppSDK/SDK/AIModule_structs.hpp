...
// Enum AIModule.EEnvQueryTestAsyncStatus
// NumValues: 0x0004
enum class EEnvQueryTestAsyncStatus : uint8
{
	None                                     = 0,
	Processing                               = 1,
	Completed                                = 2,
	EEnvQueryTestAsyncStatus_MAX             = 3,
};
...
public:
	...
	uint8                                         Pad_2C[0xC];                                       // 0x002C(0x000C)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_39[0x3];                                       // 0x0039(0x0003)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_8[0x38];                                       // 0x0008(0x0038)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_1[0x1];                                        // 0x0001(0x0001)(Fixing Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_8[0x178];                                      // 0x0008(0x0178)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_18[0x50];                                      // 0x0018(0x0050)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_18[0x14];                                      // 0x0018(0x0014)(Fixing Size After Last Property [ Rei-SdkDumper ])
