...
namespace Offsets
{
	constexpr int32 GObjects          = 0x075B0A58;
	constexpr int32 AppendString      = 0x027B8460;
	constexpr int32 GNames            = 0x075981C0;
	constexpr int32 GWorld            = 0x076FFF08;
	constexpr int32 ProcessEvent      = 0x029D3E50;
