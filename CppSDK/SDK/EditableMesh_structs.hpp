...
public:
	...
	uint8                                         Pad_C[0x3C];                                       // 0x000C(0x003C)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_8[0x4];                                        // 0x0008(0x0004)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
