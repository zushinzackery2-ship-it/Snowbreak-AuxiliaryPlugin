...
{
public:
	float                                         VirtualTextureMainPassMaxDrawDistance;             // 0x0508(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_50C[0x4];                                      // 0x050C(0x0004)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_290[0x20];                                     // 0x0290(0x0020)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_2E9[0x3];                                      // 0x02E9(0x0003)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_328[0x64];                                     // 0x0328(0x0064)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_38D[0x3];                                      // 0x038D(0x0003)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         BitPad_394_3 : 5;                                  // 0x0394(0x0001)(Fixing Bit-Field Size For New Byte [ Rei-SdkDumper ])
	...
	uint8                                         BitPad_398_1 : 7;                                  // 0x0398(0x0001)(Fixing Bit-Field Size For New Byte [ Rei-SdkDumper ])
	...
	uint8                                         BitPad_39C_1 : 7;                                  // 0x039C(0x0001)(Fixing Bit-Field Size For New Byte [ Rei-SdkDumper ])
	...
	uint8                                         BitPad_3A0_1 : 7;                                  // 0x03A0(0x0001)(Fixing Bit-Field Size For New Byte [ Rei-SdkDumper ])
	...
	uint8                                         Pad_3A6[0x2];                                      // 0x03A6(0x0002)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_3AD[0x3];                                      // 0x03AD(0x0003)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_3DC[0x4];                                      // 0x03DC(0x0004)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_539[0x3];                                      // 0x0539(0x0003)(Fixing Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_4D8[0x8];                                      // 0x04D8(0x0008)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_4F4[0xC];                                      // 0x04F4(0x000C)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_5D4[0x4];                                      // 0x05D4(0x0004)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_5E1[0x7];                                      // 0x05E1(0x0007)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_610[0x70];                                     // 0x0610(0x0070)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_47C[0x4];                                      // 0x047C(0x0004)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_4D8[0x10];                                     // 0x04D8(0x0010)(Fixing Size After Last Property [ Rei-SdkDumper ])
	TArray<class UPhysicalMaterial*>              CookedPhysicalMaterials;                           // 0x04E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_4F8[0x40];                                     // 0x04F8(0x0040)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_6C[0xA4];                                      // 0x006C(0x00A4)(Fixing Size After Last Property [ Rei-SdkDumper ])
	TArray<class ALandscapeStreamingProxy*>       Proxies;                                           // 0x0110(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_120[0xF0];                                     // 0x0120(0x00F0)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	uint8                                         Pad_28[0x58];                                      // 0x0028(0x0058)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	TArray<struct FLandscapeMaterialTextureStreamingInfo> TextureStreamingInfo;                      // 0x0380(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         bIsLayerThumbnail : 1;                             // 0x0390(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDisableTessellation : 1;                          // 0x0390(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMobile : 1;                                       // 0x0390(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEditorToolUsage : 1;                              // 0x0390(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_391[0x7];                                      // 0x0391(0x0007)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_548[0x8];                                      // 0x0548(0x0008)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	struct FGuid                                  LandscapeGuid;                                     // 0x0508(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FIntPoint>                      ProxyComponentBases;                               // 0x0518(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	int8                                          ProxyLOD;                                          // 0x0528(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_529[0x7];                                      // 0x0529(0x0007)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_488[0x8];                                      // 0x0488(0x0008)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_5BC[0x4];                                      // 0x05BC(0x0004)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_4C[0x8];                                       // 0x004C(0x0008)(Fixing Size After Last Property [ Rei-SdkDumper ])
