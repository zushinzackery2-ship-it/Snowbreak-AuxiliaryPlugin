...
void ULevelSequencePlayer::EnableControlPlayerCharacter(bool bValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("LevelSequencePlayer", "EnableControlPlayerCharacter");

	Params::LevelSequencePlayer_EnableControlPlayerCharacter Parms{};
