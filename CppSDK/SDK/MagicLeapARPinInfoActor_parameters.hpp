...
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x00E8(0x008C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	float                                         K2Node_Event_DeltaSeconds;                         // 0x0174(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                               CallFunc_RInterpTo_ReturnValue;                    // 0x0178(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_184[0x4];                                      // 0x0184(0x0004)(Fixing Size After Last Property [ Rei-SdkDumper ])
	class FString                                 CallFunc_ARPinIdToString_ReturnValue;              // 0x0188(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x01CC(0x008C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FMagicLeapARPinState                   CallFunc_GetARPinState_State;                      // 0x0258(0x0014)(NoDestructor)
	EMagicLeapPassableWorldError                  CallFunc_GetARPinState_ReturnValue;                // 0x026C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x026D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_26E[0x2];                                      // 0x026E(0x0002)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	class FText                                   CallFunc_Conv_FloatToText_ReturnValue_1;           // 0x02B0(0x0018)()
	class FText                                   CallFunc_Conv_FloatToText_ReturnValue_2;           // 0x02C8(0x0018)()
};
