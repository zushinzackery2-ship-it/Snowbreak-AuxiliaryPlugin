...
public:
	...
	uint8                                         Pad_39[0x67];                                      // 0x0039(0x0067)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	int32                                         PassIndex;                                         // 0x0084(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
{
public:
	struct FMovieSceneFloatChannel                ComponentCurves[0x4];                              // 0x0038(0x00A0)(Protected, NativeAccessSpecifierProtected)
	int32                                         NumChannelsUsed;                                   // 0x02B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_2BD[0x3];                                      // 0x02BD(0x0003)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
// ScriptStruct MovieSceneTracks.MovieSceneSubtitleInfo
// 0x0008 (0x0008 - 0x0000)
struct FMovieSceneSubtitleInfo final
{
public:
...
DUMPER7_ASSERTS_FMovieSceneSubtitleInfo;
...
public:
	...
	uint8                                         Pad_18[0x18];                                      // 0x0018(0x0018)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_641[0x3];                                      // 0x0641(0x0003)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_649[0x7];                                      // 0x0649(0x0007)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_18[0x28];                                      // 0x0018(0x0028)(Fixing Size After Last Property [ Rei-SdkDumper ])
	TArray<struct FMovieSceneActorReferenceKey>   KeyValues;                                         // 0x0040(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_50[0x60];                                      // 0x0050(0x0060)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_2B9[0x7];                                      // 0x02B9(0x0007)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
public:
	...
	uint8                                         Pad_1C[0x1C];                                      // 0x001C(0x001C)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
...
// ScriptStruct MovieSceneTracks.MovieSceneSubtitleChannel
// 0x0080 (0x0088 - 0x0008)
struct FMovieSceneSubtitleChannel final : public FMovieSceneChannel
{
public:
	TArray<struct FFrameNumber>                   KeyTimes;                                          // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FMovieSceneSubtitleInfo>        KeyValues;                                         // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_28[0x60];                                      // 0x0028(0x0060)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
DUMPER7_ASSERTS_FMovieSceneSubtitleChannel;

// ScriptStruct MovieSceneTracks.MovieSceneSubtitleTriggerData
// 0x0024 (0x0024 - 0x0000)
struct FMovieSceneSubtitleTriggerData final
{
public:
	...
	uint8                                         Pad_18[0xC];                                       // 0x0018(0x000C)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
};
DUMPER7_ASSERTS_FMovieSceneSubtitleTriggerData;

// ScriptStruct MovieSceneTracks.MovieSceneSubtitleSectionTemplate
// 0x0008 (0x0028 - 0x0020)
struct FMovieSceneSubtitleSectionTemplate final : public FMovieSceneEvalTemplate
{
public:
	uint8                                         bTriggerSubtitleEventsWhenForwards : 1;            // 0x0020(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTriggerSubtitleEventsWhenBackwards : 1;           // 0x0020(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
