...
void UNiagaraComponent::SetQualityLevelBias(int32 Bias)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraComponent", "SetQualityLevelBias");

	Params::NiagaraComponent_SetQualityLevelBias Parms{};
...
// int32                                   QLBias                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
