...
public:
	...
	uint8                                         Pad_58[0x40];                                      // 0x0058(0x0040)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_B8[0x3E0];                                     // 0x00B8(0x03E0)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
#pragma pack(push, 0x1)
class alignas(0x10) UBasicReplicationGraph : public UReplicationGraph
{
public:
...
{
public:
	uint8                                         Pad_50[0xA8];                                      // 0x0050(0x00A8)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	uint8                                         Pad_50[0xE8];                                      // 0x0050(0x00E8)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	uint8                                         Pad_F8[0x30];                                      // 0x00F8(0x0030)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	uint8                                         Pad_F8[0x98];                                      // 0x00F8(0x0098)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	uint8                                         Pad_50[0x1E0];                                     // 0x0050(0x01E0)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
{
public:
	uint8                                         Pad_F8[0x18];                                      // 0x00F8(0x0018)(Fixing Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_60[0x18];                                      // 0x0060(0x0018)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
...
public:
	...
	uint8                                         Pad_30[0x140];                                     // 0x0030(0x0140)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_178[0x10];                                     // 0x0178(0x0010)(Fixing Size After Last Property [ Rei-SdkDumper ])
	...
	uint8                                         Pad_1B8[0x80];                                     // 0x01B8(0x0080)(Fixing Struct Size After Last Property [ Rei-SdkDumper ])
