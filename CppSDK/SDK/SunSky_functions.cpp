...
// Parameters:
// bool                                    DSTEnable                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// bool*                                   IsDST_0                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
// Parameters:
// float                                   SolarTime_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ASunSky_C::GetHMSFromSolarTime(float SolarTime_0, int32* Hour, int32* Minute, int32* Second)
{
	static class UFunction* Func = nullptr;
